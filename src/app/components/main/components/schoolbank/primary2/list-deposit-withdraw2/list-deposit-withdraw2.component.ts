...
@Component({
  selector: 'app-list-deposit-withdraw2',
  templateUrl: './list-deposit-withdraw2.component.html',
  styleUrls: ['./list-deposit-withdraw2.component.css']
})
export class ListDepositWithdraw2Component implements OnInit {
