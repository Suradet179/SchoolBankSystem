...
@Component({
  selector: 'app-list-student3',
  templateUrl: './list-student3.component.html',
  styleUrls: ['./list-student3.component.css']
})
export class ListStudent3Component implements OnInit {
