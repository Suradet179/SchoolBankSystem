...
@Component({
  selector: 'app-list-student4',
  templateUrl: './list-student4.component.html',
  styleUrls: ['./list-student4.component.css']
})
export class ListStudent4Component implements OnInit {
