...
@Component({
  selector: 'app-list-deposit-withdraw4',
  templateUrl: './list-deposit-withdraw4.component.html',
  styleUrls: ['./list-deposit-withdraw4.component.css']
})
export class ListDepositWithdraw4Component implements OnInit {
