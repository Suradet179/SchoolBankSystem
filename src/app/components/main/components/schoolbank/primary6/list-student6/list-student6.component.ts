...
@Component({
  selector: 'app-list-student6',
  templateUrl: './list-student6.component.html',
  styleUrls: ['./list-student6.component.css']
})
export class ListStudent6Component implements OnInit {
