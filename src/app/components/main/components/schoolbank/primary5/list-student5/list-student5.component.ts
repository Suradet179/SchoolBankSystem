...
@Component({
  selector: 'app-list-student5',
  templateUrl: './list-student5.component.html',
  styleUrls: ['./list-student5.component.css']
})
export class ListStudent5Component implements OnInit {
